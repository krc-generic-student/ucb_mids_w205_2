...
The size of the dataset is 983,648.
...
This is my question in english

  * Answer:  
  
This is the answer to my question in english.
...
```
bq query --use_legacy_sql=false "SELEC
T count(*) FROM \`bigquery-public-data.san_francisco.bikeshare_trips\` where start_station_name = 'Mezes' "
Waiting on bqjob_r2b751859a60c0779_000001748f334ed1_1 ... (0s) Current status: DONE   
+-----+
| f0_ |
+-----+
| 119 |
